                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                @elseif($admins -> is_active == 1) <!-- Si el usuario no ha accedido y esta inactivo -->
                                    <input class="form-control" value="En Linea" type="text" placeholder="Default input" aria-label="default input example" disabled>
                                @else <!-- Si el usuario ha accedido -->
                                    <input class="form-control" value="{{ \Carbon\Carbon::parse($admins -> last_login) -> format('d/m/Y') }} a las {{ \Carbon\Carbon::parse($admins -> last_login) -> format('H:i') }} hrs." type="text" placeholder="Default input" aria-label="default input example" disabled>
                                @endif
